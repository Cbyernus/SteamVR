...
This means that you will have to use only one API to access headset position whether the user uses Oculus, Mixed Reality, or Vive headset instead of using multiple API.
